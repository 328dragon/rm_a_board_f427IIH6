...
void Control::Control_t::doCalcontrol()
{																																																								 
    (*_servoX).control( (*_servoX)._target_angle );
    (*_servoY).control((*_servoY)._target_angle);
}

void Control::Control_t::doYawcontrol()
{
    _servoYAW->control(_yaw);
}